package com.tutorial.codegen.config;
...
public class OpenAPIDocumentationConfig {
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.swaggerPetstore.base-path:/Abacus9/TP-PetStore/1.0.0}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.tutorial.codegen.controllers"))
                    .build()
